...
:::info[Note that dscmd cannot query a pbix/pbip file directly, the file needs to be already open in Power BI Desktop.]
:::
...
From #1361:  The results pane now has an improved error display with a number of user experience improvements.
...
From #1358. The Query text in the Server Timings window now has line numbers to make it easier to reference parts of the query when doing presentations or screenshares.
