...
* <span>You can become a financial sponsor  <a href="/sponsors">  <div className="button button button--secondary">  <i className="fa fa-heart-circle-plus" style={{margin: "5px", color: "salmon"}}/>Sponsor</div></a></span>
