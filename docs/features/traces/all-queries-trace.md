...
When connecting the _All Queries_ trace to to Power BI you need to be aware that Power BI has its own level of internal caching. At a very high level it looks something like the following:
